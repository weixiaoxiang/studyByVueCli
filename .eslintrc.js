...
// “error” 或 2 - 开启规则，使用错误级别的错误：error (当被触发的时候，程序会退出) 严格规则

// rules文档
//https://cloud.tencent.com/developer/section/1135587
//eslint-plugin-vue文档
//https://eslint.vuejs.org/rules/
module.exports = {
  root: true, //停止在父级目录中寻找ESLint配置文件
  parserOptions: {
  ...
  extends: ['plugin:vue/recommended', 'eslint:recommended'], //启用所有默认规则，即开启最严格规则
